...
public class Pesquisar extends HttpServlet {
    ...
    protected void processRequest ( HttpServletRequest request, HttpServletResponse response )
        ...
        if ( request.getServletPath().equals( "/Pesquisar" ) ) {

            String consulta = request.getParameter( "pesquisar" );
            ...
            if ( !consulta.trim().isEmpty() ) {
                ...
                DadosUsuarioSessao.blocosEncontrados = blockchain.pesquisarBlocos( consulta );

                response.sendRedirect( "blockchain_usuario.jsp" );

            }else{
                
                DadosUsuarioSessao.blocosEncontrados = new ArrayList();
                response.sendRedirect( "blockchain_usuario.jsp" );
