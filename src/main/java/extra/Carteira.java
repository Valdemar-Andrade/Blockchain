...
public class Carteira {
    ...
    public Transacao criarTransacao(PublicKey receptor, double quantia, Blockchain blockchain) {
        
        if (blockchain.getBalanco(this.chavePublica) < quantia) {
            System.out.println("Saldo insuficiente para realizar a transação.");
            
            return null;
        }
        
        Transacao novaTransacao = new Transacao(chavePublica, receptor, quantia);
